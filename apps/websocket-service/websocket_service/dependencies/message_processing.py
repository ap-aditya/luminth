...
async def process_payload(
    ...
    request_timestamp = payload_data.get("request_timestamp")
    ...
    if status == 'success' and video_url:
        ...
        await config["update"](session=session, **item_id_kwargs, **{"canvas_update" if source_type == "canvas" else "prompt_update": update_data})
