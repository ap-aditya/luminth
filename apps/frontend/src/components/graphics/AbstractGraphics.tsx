...
const AbstractGraphics: FC = () => (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
        <svg viewBox="0 0 200 200" className="absolute w-4/5 h-4/5 text-cyan-400/30 dark:text-cyan-300/20 animate-spin-slow">
            <circle cx="100" cy="100" r="80" stroke="currentColor" strokeWidth="1" fill="none" />
            <ellipse cx="100" cy="100" rx="80" ry="40" stroke="currentColor" strokeWidth="0.5" fill="none" />
            <ellipse cx="100" cy="100" rx="80" ry="40" transform="rotate(60 100 100)" stroke="currentColor" strokeWidth="0.5" fill="none" />
            <ellipse cx="100" cy="100" rx="80" ry="40" transform="rotate(120 100 100)" stroke="currentColor" strokeWidth="0.5" fill="none" />
        </svg>
