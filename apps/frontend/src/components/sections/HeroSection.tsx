  ...
  <section className="relative pt-40 md:pt-48 pb-20 md:pb-32 text-center bg-gray-50 dark:bg-gray-700 overflow-hidden">
    ...
    <div className="container mx-auto px-4 sm:px-6 relative z-10">
      ...
      <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
        Create stunning mathematical animations directly in your browser. From
        simple equations to complex scenes, bring math to life with the power of
        Manim.
      </p>
      <Link href="/auth/signup">
        <button className="group relative inline-flex items-center justify-center px-8 py-3 text-lg font-bold text-white bg-cyan-500 rounded-xl overflow-hidden transition-all duration-300 ease-in-out hover:bg-cyan-600 shadow-[0_0_25px_rgba(6,182,212,0.5)]">
